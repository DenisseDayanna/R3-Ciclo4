...
public class Fragment_Sucursales extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        drawable1 = res1.getDrawable(R.drawable.cc1, v.getContext().getTheme());
        ...
        drawable2 = res2.getDrawable(R.drawable.cc2, v.getContext().getTheme());
        ...
        drawable3 = res3.getDrawable(R.drawable.cc3, v.getContext().getTheme());
        ...
        drawable4 = res4.getDrawable(R.drawable.cc4, v.getContext().getTheme());
